...
def check_image(input_file, caffe_transformer, nsfw_net):   
...
input_file = '/home/cc/Desktop/computer_network/open_nsfw/th.png'
print(check_image(input_file, caffe_transformer,nsfw_net))